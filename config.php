...
// ── Session ───────────────────────────────────────────
// Müşteri portal dosyaları config.php include etmeden önce
// CODEGA_NO_AUTO_SESSION sabitini tanımlayabilir.
if (!defined('CODEGA_NO_AUTO_SESSION') && session_status() === PHP_SESSION_NONE) {
